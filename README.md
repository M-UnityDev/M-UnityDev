...
# Current Projects:
#### Personal Miscellaneous Projects:
|Name|Current State|Version|Current Stack|Description|
|-|-|-|-|-|
|GDScREPL|Published Demo|0.2|Godot (GDScript)|Godot CLI REPL inspired by Python's one|
|UESC (UNICODE ESCAPE SEQUENCE CATCHER)|Published|1.1|Python|Simple python script that translates every Unicode Escape Sequence in a given file into English|
|MTPS (M-Unity's TextPack Support)|Published|0.9|Unity Package|Library for managing user-generated text packets, can be used as a simple localization system|
|MVNF (M-Unity's Visual Novel Framework)|Published Demo|0.5|Godot Plugin (GDScript)|Feature rich and easy to use plugin for creating visual novels in Godot|
|MCALR (M-Unity's Custom Arch Linux Rice)|Published|1.1|Bash|My Arch Linux Dotfiles :3|
...
#### States:
- Published - Finished project that will receive updates
- Published Demo - A demo of unfinished project that is in (almost) active development
- Unpublished - Unfinished project that is in (almost) active development
- Unsupported - Abandoned/Canceled project that will no longer receive updates
